...
import com.inspiroes.attendance.LoginActivity
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        doAsync {
            ...
            if (response.body() != null) {
                ...
                uiThread {
                    eventsRecyclerView.layoutManager = LinearLayoutManager(this@EventsActivity, LinearLayoutManager.VERTICAL, false)
